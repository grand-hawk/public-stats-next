...
This vehicle features a single addon: **Anti-Tank Drones**. This addon costs 1500 points and equips the vehicle with four commander-operated HERO-120 Top-Attack FNF drones. These loitering munitions feature 700mm of maximum penetration, allowing the operator to engage heavy armor from extreme stand-off distances. However, the integration of the drone control systems and storage comes at a significant cost to the vehicle's primary armament capacity: the ready rack capacity is reduced by half, dropping from 20 shells to just 10 shells. This drastically limits the tank's sustained firing capability in prolonged direct-fire engagements.
