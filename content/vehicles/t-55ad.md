...
This vehicle features a single add-on: **T-55AMD-1**. The T-55AMD-1 add-on costs 750 points and equips the T-55AD with a reinforced Upper Frontal Plate (UFP) consisting of composite BDD applique armor, which marginally increases survivability against kinetic rounds while providing a massive boost against chemical threats. Additionally, this upgrade equips the tank with the 9M117 Bastion ATGM and its dedicated guidance sight; this barrel-launched missile features 600mm of maximum penetration, significantly improving the vehicle's long-range lethality against even the most heavily armoured main battle tanks.
