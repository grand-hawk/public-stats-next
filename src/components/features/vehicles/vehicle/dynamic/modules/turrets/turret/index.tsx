...
import Sights from '@/components/features/vehicles/vehicle/dynamic/modules/turrets/turret/sights';
import Weapons from '@/components/features/vehicles/vehicle/dynamic/modules/turrets/turret/weapons';
