...
export const CALIBRE_BANDS = [
  {
    key: 'tiny',
    label: '≤ 20',
    test: (c: number) => c > 0 && c <= 20,
  },
  {
    key: 'small',
    label: '21–60',
    test: (c: number) => c > 20 && c <= 60,
  },
  {
    key: 'medium',
    label: '61–90',
    test: (c: number) => c > 60 && c <= 90,
  },
  {
    key: 'large',
    label: '91–110',
    test: (c: number) => c > 90 && c <= 110,
  },
  {
    key: 'xlarge',
    label: '111–125',
    test: (c: number) => c > 110 && c <= 125,
  },
  {
    key: 'huge',
    label: '126+',
...
export type CalibreBand = (typeof CALIBRE_BANDS)[number]['key'];
